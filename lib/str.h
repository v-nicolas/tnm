...
#define STREQ(y,z) (*y == *z && !strcmp(y, z))
#define STRNEQ(y,z) (*y != *z || strcmp(y, z))

int xstrtol(const char *str, int *v, int base);
int xstrtoul(const char *str, unsigned long int *v, int base);

#endif /* not have LIB_STR_H */
